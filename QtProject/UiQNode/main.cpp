...
/*
 <READ ME>
 This tutorial is to show how to use 3D object (TestCube for this case) as class so that it is cleaner to use in SceneModifier
and its rotation can be set easily. */
